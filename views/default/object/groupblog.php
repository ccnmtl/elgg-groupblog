			...
			if (get_context() == "search") {
				...
				if (get_input('search_viewtype') == "gallery") {
					...
					//display the gallery view
            				echo elgg_view("groupblog/gallery",$vars);

				} else {
				
					echo elgg_view("groupblog/listing",$vars);
		...
		<div class="groupblog_post_icon">
			...
			<p class="strapline">
				<?php
					...
					echo sprintf(elgg_echo("groupblog:strapline"),
									date("F j, Y",$vars['entity']->time_created)
					);
				
				?>
				<?php echo elgg_echo('by'); ?> <a href="<?php echo $vars['url']; ?>pg/groupblog/owned/<?php echo $vars['entity']->getOwnerEntity()->username; ?>"><?php echo $vars['entity']->getOwnerEntity()->name; ?></a> &nbsp; 
			...
			<?php
				...
				?>
					<a href="<?php echo $vars['url']; ?>pg/groupblog/edit/<?php echo $vars['entity']->getGUID(); ?>"><?php echo elgg_echo("edit"); ?></a>  &nbsp; 
					<?php
					
						echo elgg_view("output/confirmlink", array(
																	'href' => $vars['url'] . "action/groupblog/delete?blogpost=" . $vars['entity']->getGUID(),
